...
def addform():
    ...
    try:
        ...
        email2 = user1.email
        msg = Message('Weekly Activity Tracker :'+Activitydate[:10], sender = 'lticmtproject@gmail.com', recipients = [email1])
        ...
        mail.send(msg)
        msg = Message('Weekly Activity Tracker :'+Activitydate[:10], sender = 'lticmtproject@gmail.com', recipients = [email2])
